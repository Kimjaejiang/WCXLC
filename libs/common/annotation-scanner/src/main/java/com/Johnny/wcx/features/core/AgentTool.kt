...
/**
 * Marks a function as a WeAgent built-in tool. The [com.Johnny.wcx.features.AgentToolScanner] KSP processor
 ...
 * so no hand-written mapping table is needed and new [com.Johnny.wcx] APIs are picked up
