 ...
 * 一次 {@code is ChattingRecyclerView} 检查即可覆盖两种运行时类型。桩继承 AndroidX
 * RecyclerView, 以让 Kotlin 的 {@code is} 类型检查在编译期成立 (运行时真实类同样
 * 是 RecyclerView 子类)。
 */
public class ChattingRecyclerView extends android.view.ViewGroup {
