    ...
    override fun resolveDex(dexKit: DexKitBridge) {
        ...
        when (subCoreMultiTalkClasses.size) {
            ...
            0 -> {
                ...
                classSubCoreMultiTalk.setPlaceholderDescriptor(reason)
                methodExitMultiTalk.setPlaceholderDescriptor(reason)
                classILinkService.setPlaceholderDescriptor(reason)
                classILinkMember.setPlaceholderDescriptor(reason)
                classInviteTask.setPlaceholderDescriptor(reason)
                methodGetMultiTalkManager.setPlaceholderDescriptor(reason)
                methodSetStatus.setPlaceholderDescriptor(reason)
                methodSetMtSdkMode.setPlaceholderDescriptor(reason)
                methodSetName.setPlaceholderDescriptor(reason)
                methodPostTask.setPlaceholderDescriptor(reason)
                ctorInviteTask.setPlaceholderDescriptor(reason)
                ctorHangupTask.setPlaceholderDescriptor(reason)
                fieldILinkInstance.setPlaceholderDescriptor(reason)
                fieldRoomId.setPlaceholderDescriptor(reason)
                return
            }
