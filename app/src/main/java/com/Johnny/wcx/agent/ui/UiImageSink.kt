 ...
 *
 * Installed by [com.Johnny.wcx.features.api.agent.WeAgentService] around
 * [com.Johnny.wcx.agent.engine.AgentSessionEngine.runTurn], mirroring
 * [com.Johnny.wcx.agent.workspace.VfsContext]. Screenshots are intentionally NOT persisted to
