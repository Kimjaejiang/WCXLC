...
/**
 * API-agnostic conversation types consumed by the [com.Johnny.wcx.agent.engine] loop. The
 ...
 * [com.Johnny.wcx.agent.engine.AgentSessionEngine.runTurn] tool loop and is **not** persisted —
