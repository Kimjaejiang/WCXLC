...
import com.Johnny.wcx.agent.data.WeAgentRepository.getExternalServiceKey
import com.Johnny.wcx.agent.data.WeAgentRepository.permissionCache
...
import com.Johnny.wcx.agent.tool.ToolPermissionSource
...
object WeAgentRepository : ToolPermissionSource {
     ...
     */
    suspend fun updateSessionUsage(id: String, usage: com.Johnny.wcx.agent.model.LlmUsage?) {
        ...
        toolCalls.forEach { tc ->
            ...
            db.toolCallDao().upsert(
                ToolCallEntity(
                    ...
                    resultJson = null,
                    approvalStatus = com.Johnny.wcx.agent.data.entity.ApprovalStatus.AUTO_ALLOWED,
                    approvalReason = null,
                    executedAt = null,
    ...
    suspend fun appendToolResult(
        ...
        resultText: String,
        status: com.Johnny.wcx.agent.data.entity.ApprovalStatus,
    ) {
    ...
    suspend fun deleteModelProvider(id: String) {
        ...
        com.Johnny.wcx.agent.model.ModelProviderManager.invalidate(id)
    }
    ...
    suspend fun upsertMcpProvider(provider: ProviderEntity) {
        ...
        com.Johnny.wcx.agent.mcp.McpClientManager.sync()
    }
    ...
    suspend fun upsertWorkspace(w: com.Johnny.wcx.agent.data.entity.WorkspaceEntity) =
    ...
    suspend fun observeWorkspacesOnce(): List<com.Johnny.wcx.agent.data.entity.WorkspaceEntity> =
    ...
    fun observeTriggers(): Flow<List<com.Johnny.wcx.agent.data.entity.TriggerEntity>> =
        db.triggerDao().observeAll()

    suspend fun getAllTriggersOnce(): List<com.Johnny.wcx.agent.data.entity.TriggerEntity> =
        db.triggerDao().getAllOnce()

    suspend fun getEnabledTriggers(): List<com.Johnny.wcx.agent.data.entity.TriggerEntity> =
        db.triggerDao().getEnabled()

    suspend fun getTrigger(id: String): com.Johnny.wcx.agent.data.entity.TriggerEntity? =
        db.triggerDao().getById(id)

    suspend fun getTriggersForSession(sessionId: String): List<com.Johnny.wcx.agent.data.entity.TriggerEntity> =
        db.triggerDao().getForSession(sessionId)

    suspend fun upsertTrigger(trigger: com.Johnny.wcx.agent.data.entity.TriggerEntity) =
