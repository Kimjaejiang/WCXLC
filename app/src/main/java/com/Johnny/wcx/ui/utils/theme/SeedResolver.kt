...
import com.Johnny.wcx.ui.utils.theme.SeedResolver.customSeed

/**
 * Single source of truth for turning [ThemeSettings] into a concrete accent seed and the derived
 * Material 3 / miuix color schemes. Shared by [ModuleTheme], [com.Johnny.wcx.ui.utils.InjectedUiTheme], and
 * [com.Johnny.wcx.features.items.beautify.MonetEngine] so the module UI, the WeKit UI injected
